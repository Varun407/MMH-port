  ...
  return (
    <section className="section" id="expertise">
      <div className="container" style={{ textAlign: 'center', marginBottom: '4rem' }}>
        <h2 className="section-title" style={{ fontSize: '3.2rem', fontWeight: 800, marginBottom: '1rem', background: 'linear-gradient(135deg, #f8fafc 0%, #60a5fa 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Tools</h2>
      ...
      <div className="container">
            ...
            <div style={{
              ...
              <div style={{ zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{ width: '80px', height: '80px', borderRadius: '1.2rem', background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.1)', marginBottom: '1.5rem', boxShadow: '0 10px 25px rgba(0,0,0,0.5)' }}>
                  <img src="davinci.svg" width="45" height="45" alt="DaVinci Resolve" />
                </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '6rem', marginBottom: '3rem' }}>
          <h3 style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '0.5rem', background: 'linear-gradient(135deg, #f8fafc 0%, #60a5fa 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Other Tools</h3>
        </div>
